...
import { CreditCard as CreditCardIcon, Smartphone, Pencil, Trash2, Send } from "lucide-react";
...
import { RequestDeletionModal } from "@/features/family-account";

interface CreditCardDisplayProps {
  card: CreditCardData & { canEdit?: boolean; canDelete?: boolean };
  spent?: number;
...
export function CreditCardDisplay({ card, spent = 0, onEdit, onDelete }: CreditCardDisplayProps) {
  ...
  const canEdit = card.canEdit ?? true;
  const canDelete = card.canDelete ?? true;
          ...
          <div className="flex items-start justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-1 invisible group-hover:visible">
              ...
              <Button
                ...
                title={canDelete ? "Excluir" : "Solicitar exclusao"}
              >
                {canDelete ? (
          ...
          <div className="flex items-end justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {card.type === "physical" ? "Fisico" : "Virtual"}
              </Badge>
            </div>
          </div>
          ...
          {card.limit && (
            <div className="mt-4 pt-4 border-t border-white/20">
              <div className="flex items-center justify-between text-sm mb-2">
                <span className="text-white/70">Gasto este mes</span>

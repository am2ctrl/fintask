...
import { Check, RotateCcw, Eye, Pencil, Trash2, ChevronDown, Send } from "lucide-react";
...
interface PaymentRowProps {
  payment: Transaction & { canEdit?: boolean; canDelete?: boolean };
  onClick: () => void;
  onToggleStatus: () => void;
  onEdit: () => void;
  onDelete: () => void;
...
export function PaymentRow({ payment, onClick, onToggleStatus, onEdit, onDelete }: PaymentRowProps) {
  ...
  const canEdit = payment.canEdit ?? true;
  const canDelete = payment.canDelete ?? true;
